...
<body>
	<div class="container border bg-light">
		<h2>
			...
			<div class="row mb-3 gy-2">
				<label for="address2" class="col-sm-4 col-form-label">Signup
					Date</label>
			...
			<div class="row mb-3 gy-2">
				<label class="col-sm-4">Profile IMG</label>
				<div class="col-sm-6">
					<img src="/images/no_profile.png" id="profile" style="width: 100%;">
				</div>
			</div>
			<div id="center">
				<button type="button" class="btn btn-primary" id="Modify">Modify</button>
				<button type="button" class="btn btn-primary"
					onclick="history.back(); return false;">Back</button>
			</div>
	</div>
...
$(function(){
	if($("#profile").attr("src") == "" || $("#profile").attr("src") == null){
		$("#profile").attr("src", "/images/no_profile.png");
	} else {
		$("#profile").attr("src", "/profile/${list.profile}");
	}
})
